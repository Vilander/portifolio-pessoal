      ...
      <header className="cabecalho-principal">
        <div className="conteudo-cabecalho">
          <figure className="logo">
            <a href="../index.html"><img className="icone-sup" src="\src\assets\logo_vertical_VC_white.png"
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="sobre.html" role="button" data-bs-toggle="dropdown"
                      aria-expanded="false">
                      &lt;SOBRE MIM&gt;
                    </a>
                    <ul className="dropdown-menu">
                      <li><a className="dropdown-item" href="/Pages/sobre.html#bio-pessoal">Hello Word</a></li>
                      <li><a className="dropdown-item" href="/sobre.html#formação-academica">Formação Acadêmica</a></li>
                      <li><a className="dropdown-item" href="/sobre.html#cursos">Cursos complementares</a></li>
                      <li><a className="dropdown-item" href="/sobre.html#skills">Habilidade Técnicas</a></li>
                      <li><a className="dropdown-item" href="/sobre.html#CLT">Experiências Profissionais</a></li>
                    </ul>
                  </li>
                  <li className="nav-item dropdown">
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu">
                      <li><a className="dropdown-item" href="blog.html">Eventos</a></li>
                      <li><a className="dropdown-item" href="blog.html">Dicas e Notícias</a></li>
                    </ul>
                  </li>
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
